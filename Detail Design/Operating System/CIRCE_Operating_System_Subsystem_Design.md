...
|------------------------------|-----|---------------------------|-------------------------------------|---------------|------------------|
| Raspberry Pi 5 Model B (8GB) | 1   | SC1112                    | Single Board Computer, 8GB RAM      | [View on Digi-Key](https://www.digikey.com/en/products/detail/raspberry-pi/SC1112/21658257) | ~$80.00 |
