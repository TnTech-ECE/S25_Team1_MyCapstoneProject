...
- **CirceBot shall dispense cable** according to installation guidelines, including:
  ...
  - Tension tolerances to maintain the integrity of the signal through the wire.

- **CirceBot shall be equipped** with an independent power source capable of at least 20 minutes of operation in Tennessee environments.
...
- **CirceBot shall carry up to 100 yards** (approximately 10 lbs) of Ethernet cable and report error codes via self-diagnosis.  
  - It shall be rechargeable.
  - It shall send and receive commands at a minimum frequency of 10 Hz.
  - It shall communicate with CirceSoft using the WebSocket protocol.

- **CirceBot shall have a switch** to simulate GPS-denied environments and will communicate using the deployed Ethernet cable.

- **CirceBot shall stop** once the specified destination is reached and allow for:
  - Easy reloading.
  - Quick replacement of Ethernet cable reels within 2 minutes, without the use of external tools.

- **CirceBot shall use minor obstacle avoidance** to avoid collisions, meaning that if a stick, root, or rock is in the way, the robot should navigate around it to avoid damaging itself.

- **The budget for CirceBot** shall not exceed a maximum of **$2,000**. 
___
#### V. CONSTRAINTS
...
built for aerial relaying rather than continuous cable deployment. This alternative fails to meet
specifications such as physical deployment of 100 yards of ethernet cable, communication through
the cable it is deploying, exceeding the $2000 dollar maximum, etc. 
...
cable deployment. This alternative fails to meet the specificationssuch as physical deployment of the 
cable, communication through the cable, rechargable battery, etc. Their operation is also heavily 
influenced by weather conditions, and they lack the capability to navigate rugged, GPS-denied areas [4].
...
their dependence on preprogrammed flight paths, along with imprecise cable management, creates 
challenges for proper Ethernet installation [5]. This approach also fails to meeet specifications such as the
ability to navigate in GPS denied environemtns (as they use GPS to fly their path), exceeding the $2000 maximum, communication through the 
cable, etc.
___
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Starting in September, the ME team will begin the physical build of the robot. The project team will work closely with the ME team to answer any questions and make adjustments as needed. A few weeks in October will be dedicated to troubleshooting any issues that arise during the build process to ensure everything runs smoothly from design to deployment.
___
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; From an ethical standpoint, CIRCEBOT mitigates risk to personnel by replacing human operators in dangerous environments. Unlike autonomous combat systems, its sole purpose is to establish secure communication lines, supporting coordination and potentially aiding in conflict resolution without endangering friendly forces. Engineers must ensure the robot functions reliably—any failure mid-mission could result in critical communication breakdowns, potentially leading to loss of life.  
